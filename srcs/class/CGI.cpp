...
//int CGI::config_cgi(Routes route, Server serv, std::string method, std::string file, std::string content, Client *client, Request req)
//{
//	char **tmp = getEnv();
//	char **env;
//	int i(0);
...
//	else if (pid == 0)
//	{
//		fcntl(tochild[0], F_SETFL, O_NONBLOCK);
//        dup2(tochild[0], 0);
//        dup2(fromchild[1], 1);
//        close(tochild[1]);
//        close(fromchild[0]);
...
//		if (execve(getRoutes().getCGIPath().c_str(), av, getEnv()) < 0)
//			throw CGI::CGIException();
//		exit(0);
//	}
//    else
...
//        close(tochild[0]);
//        close(fromchild[1]);
//        lseek(, getClient()->getRecvEnd() + 4, SEEK_SET);
//        fcntl(tochild[1], F_SETFL, O_NONBLOCK);
//        fcntl(fromchild[0], F_SETFL, O_NONBLOCK);
//        c._fd_read = fromchild[0];
//        c._fd_write = tochild[1];
//        FD_SET(c._fd_read, &(c._read_fd));
//        FD_SET(c._fd_write, &(c._write_fd));
//        ft_free_strs_tab(av);
//        ft_free_strs_tab(env);
//    }
...
////        close(tochild[0]);
////        close(fromchild[1]);
////        lseek(c._fd_tmp, h._h_end + 4, SEEK_SET);
////        noblock(tochild[1]);
////        noblock(fromchild[0]);
////        c._fd_read = fromchild[0];
////        c._fd_write = tochild[1];
